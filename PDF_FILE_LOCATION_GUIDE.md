...
```
應用文件夾/PDF/
├── 心域_醫師摘要_20240101-20240128.pdf
├── 心域_醫師摘要_20240128-20240225.pdf
└── ...
```
...
- `心域_醫師摘要_20240101-20240128.pdf` → 1月1日至1月28日
- `心域_醫師摘要_20240315-20240411.pdf` → 3月15日至4月11日
- `心域_醫師摘要_20241201-20241228.pdf` → 12月1日至12月28日
...
✅ PDF 導出成功: /data/data/com.example.moodsogood_app/app_documents/PDF/心域_醫師摘要_20240101-20240128.pdf
```
...
✅ **默認位置**：應用程式文件夾 > PDF  
✅ **文件名格式**：`心域_醫師摘要_YYYYMMDD-YYYYMMDD.pdf`  
