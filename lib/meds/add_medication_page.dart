...
// 候選結果：[{id, zh, en}]
            ...
            data: Theme.of(context).copyWith(
              ...
              switchTheme: Theme.of(context).switchTheme.copyWith(
                ...
                trackColor: WidgetStateProperty.resolveWith((states) {
                  ...
                  return HealingDesignSystem.adaptiveCardBorder(context);
                }),
              ),
            ),
            child: ListView(
                ...
                _SectionCard(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (_medType == 'tablet' && !_isCompoundDrug)
                        const SizedBox(height: 10),
                      if (_medType == 'tablet' && !_isCompoundDrug)
                        Row(
                          children: [
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context)
          .showSnackBar(const SnackBar(content: Text('已新增藥物')));
    } catch (e) {
      if (!mounted) return;
      ScaffoldMessenger.of(context)
