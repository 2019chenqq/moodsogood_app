...
const { withFreeQuota, readQuota, taipeiDay, MODES, RESERVATION_MS } = require("../../src/ai/innera_free_quota");
...
test("test Pro can continue after exhausting free quota without spending more", async () => {
  const { requireProEntitlement } = require("../../src/ai/pro_entitlement");
  const f = fixture();
