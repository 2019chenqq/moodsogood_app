...
} = require("../../src/chat/innera_physical_health");
const { normalizeInneraEventDrafts } = require("../../src/health_events/innera_event_drafts");
const { inneraModePrompt } = require("../../src/chat/prompts/innera_mode_prompt");
...
test("medical urgency still bypasses the general OpenAI flow", () => {
  const source = fs.readFileSync(require.resolve("../../src/chat/handler"), "utf8");
