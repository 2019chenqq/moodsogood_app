...
const { journalReflectionResponseFormat, normalizeReflection } = require('../../src/diary/journal_reflection_response');
...
test('journal callable requests and returns reflection fields rather than chat fields', async () => {
  const source = fs.readFileSync(require.resolve('../../src/diary/reflection'), 'utf8');
